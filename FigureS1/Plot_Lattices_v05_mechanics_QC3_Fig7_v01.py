...
if plotlattices:
    ...
    startname = '4x4Lattice_QC3_struc'
...
#     
#     startname = '8x8Lattice_QC3_struc'
# 
#     for ix in range(2):
#         for iy in range(2):
#             if ix==0 and iy==1:
...
#         ############################################    
#         # Add arrows to triangles
#         # 0  degree = east, positive angle is counter clockwise
#         if plotarrowsTF:
#             if  struc ==0 or struc ==2:
#                 
...
#                     for y in ylocs:
#                         trilocs+=[x,y]
#                         countlist = plotarrows(x,y,angle_ar,arrowcount,w_ar,coltri='k',arrowdepth=ardepth,relplacement = -.5,countlist=countlist)
#                         plt.show()
#                 
#                 angle_ar = 135.
#                 arrowcount=-2
...
#                     for ny  in [3]:
#                         nyinv = 7-ny
#                         arrowcountvec = np.array([0,0,0,0])
#                         countlist = plotarrowsquare(arrowcountvec,nx,ny,w_ar,a=1.,lw=2.,coltri='k',arrowdepth=ardepth,relplacement = 0.5,countlist=countlist)
#                         
#                 for nx in [3]:
#                     for ny  in [3]:
#                         nyinv = 7-ny
#                         arrowcountvec = np.array([0,3,-3,3])
#                         countlist = plotarrowsquare(arrowcountvec,nx,ny,w_ar,a=1.,lw=2.,coltri='k',arrowdepth=ardepth,relplacement = 0.5,countlist=countlist)
#                               
#                 for nx in [7]:
#                     for ny  in [3]:
...
#                     for ny  in [3]:
#                         nyinv = 7-ny
#                         arrowcountvec = np.array([3,-3,0,0])
#                         countlist = plotarrowsquare(arrowcountvec,nx,ny,w_ar,a=1.,lw=2.,coltri='k',arrowdepth=ardepth,relplacement = 0.5,countlist=countlist)
#                               
#                         
#                 #Bottom right + continuation y
...
#                     for ny  in [0,2,6]:
#                         nyinv = 7-ny
#                         arrowcountvec = np.array([-3,0,-1,0])
#                         countlist = plotarrowsquare(arrowcountvec,nx,ny,w_ar,a=1.,lw=2.,coltri='k',arrowdepth=ardepth,relplacement = 0.5,countlist=countlist)
#                               
#                 for nx in [4]:
#                     for ny  in [4]:
...
# =============================================================================
    ...
    startname = '16x16Lattice_QC3_struc'
    ...
    for struc in range(3):    
        ...
        if plotarrowsTF:
            if  struc ==0 or struc ==2:
                ...
                for nx in [0,2,6,10,14]:
                    for ny  in [4,8,12]:#[0]:
                        nyinv = 7-ny
                        arrowcountvec = -np.array([0,3,-2,1])
                        countlist = plotarrowsquare(arrowcountvec,nx,ny,w_ar,a=1.,lw=2.,coltri='k',arrowdepth=ardepth,relplacement = 0.5,countlist=countlist)

                for nx in [1,5,9,13,15]:
                    for ny  in [4,8,12]:#[0]:
                        nyinv = 7-ny
                        arrowcountvec = -np.array([0,0,2,0])
                        countlist = plotarrowsquare(arrowcountvec,nx,ny,w_ar,a=1.,lw=2.,coltri='k',arrowdepth=ardepth,relplacement = 0.5,countlist=countlist)
                ...
                for nx in [15]:
                    for ny  in [3,7,11]: #[1.,3.,5.,7.]:
                        nyinv = 7-ny
                        arrowcountvec = -np.array([0,1,0,0])
                        countlist = plotarrowsquare(arrowcountvec,nx,ny,w_ar,a=1.,lw=2.,coltri='k',arrowdepth=ardepth,relplacement = 0.5,countlist=countlist)
                        
                for nx in [15]:
                    for ny  in [4,8,12]: #[1.,3.,5.,7.]:
                        nyinv = 7-ny
                        arrowcountvec = -np.array([0,-1,0,0])
                        countlist = plotarrowsquare(arrowcountvec,nx,ny,w_ar,a=1.,lw=2.,coltri='k',arrowdepth=ardepth,relplacement = 0.5,countlist=countlist)
