...
for ind3 in MaterialIDS:
    ...
    RPT_U_Name = 'Output_U_v013_040-Mat-'+str(ind3)+'.rpt'
    U_Data_RAW = pd.read_csv(RPT_U_Name,sep='\s{2,}',skiprows=3)
    csv_XY_Name = 'Output_XYstart_v013_040.csv'
    ...
    for ind0 in range(numnodes):
        Nodes[ind0] = int(U1titlesRAW[ind0][5:])
