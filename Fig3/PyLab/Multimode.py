...
path_sys={"darwin":"/Users/coulais/science/Shared/Metacombinatorial_v2/",
          "win32":"TBD",
          "linux":"TBD"}
...
class Focus(object):
    ...
    def forcedisp(self):
        ...
        #data=np.loadtxt(mfile,skiprows=6,delimiter=";")
        data=pd.read_csv(mfile,skiprows=5)#,delimiter=",")
        self.load(dat='timeseries')
        self.timeseries.ti=np.array(data["(s)"])
        self.timeseries.ui=np.array(data["(mm)"])
        self.timeseries.Fi=np.array(data["(N)"])
